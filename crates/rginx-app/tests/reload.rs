...
fn removed_listener_drains_in_flight_request_before_going_unreachable() {
    ...
    let upstream_addr = spawn_delayed_response_server(Duration::from_millis(300), "draining\n");
    let mut server = TestServer::spawn_with_config(
...
fn spawn_delayed_response_server(delay: Duration, body: &'static str) -> SocketAddr {
