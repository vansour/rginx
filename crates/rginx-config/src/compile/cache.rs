...
fn compile_use_stale_condition(condition: CacheUseStaleConditionConfig) -> CacheUseStaleCondition {
    match condition {
        ...
        CacheUseStaleConditionConfig::Http403 => CacheUseStaleCondition::Http403,
        CacheUseStaleConditionConfig::Http404 => CacheUseStaleCondition::Http404,
        CacheUseStaleConditionConfig::Http429 => CacheUseStaleCondition::Http429,
